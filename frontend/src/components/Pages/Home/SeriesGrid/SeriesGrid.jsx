...
const SeriesGrid = React.memo(() => {
  const Filter = [
    ...
    { key: "cohort_code", name: "Cohort", values: ["COH-0000", "COH-1000100010001000", "COH-100100100100", "COH-1001100110011001", "COH-1002100210021002", "COH-1003100310031003", "COH-1004100410041004", "COH-1005100510051005", "COH-1006100610061006", "COH-1007100710071007", "COH-1008100810081008", "COH-1009100910091009", "COH-10101010", "COH-1010101010101010", "COH-101101101101", "COH-1011101111011101", "COH-1012101210121012", "COH-1013101310131013", "COH-1014101410141014", "COH-1015101510151015"] },
  ];
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="px-6 py-2 bg-[#302f2c] hover:bg-yellow-600 text-white font-semibold rounded-lg transition"
          >
            Generate Programme
          </button>
          <button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Submit Button */}
          <button onClick={handleSubmitApproval} className="w-full px-6 py-3 bg-[#302f2c] hover:bg-[#1e5edb] text-white cursor-pointer font-semibold rounded-lg transition">
            Submit for Approval
          </button>
        </div>
      </div>

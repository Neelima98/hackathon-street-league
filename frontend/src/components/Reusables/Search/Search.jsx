    ...
    <div className="flex items-center space-x-4 w-full">
      <div className="relative flex w-full md:mr-2">
        <input
          ...
          className="w-[199px] md:w-full h-[42px] p-[10px] rounded-md bg-light-primary text-dark-primary placeholder-gray-500 focus:outline-none border-1 border-dark-primary font-primary placeholder:font-fun"
        />
